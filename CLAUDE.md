...
Implication: you are editing generated/minified output, not source. Prefer **surgical, targeted string edits** over refactoring. Do not attempt to reformat or "clean up" a minified bundle. When a page needs real changes, it was almost certainly regenerated by an external tool — ask the user for the source rather than hand-editing the bundle.
